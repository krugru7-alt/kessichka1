...
function getGreeting(hour) {
  if (hour >= 6 && hour < 12) {
    return ["Доброе утро, бус ❤️", "🌅"];
  }

  if (hour >= 12 && hour < 18) {
    return ["Хорошего дня, бус ❤️", "☀️"];
  }

  if (hour >= 18 && hour < 22) {
    return ["Добрый вечер, бус ❤️", "🌆"];
  }
        ...
        <div className="portal-grid">
          ...
          >
            ...
            <div>
              ...
              <p>
                Домик, дневник и очень
                важные драконьи дела.
              </p>
          ...
          <Link
            className="portal-card room-card"
            href="/room"
          >
